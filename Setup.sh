...
lsetup "asetup AnalysisBase,21.2.0,here"
...
export PYTHONPATH=/lustre/SCRATCH/atlas/ywng/r21/r21StatisticalAnalysis/install/InstallArea/x86_64-slc6-gcc62-opt/src/Bayesian/plotting/PythonModulesa:${PYTHONPATH}
#setup numpy
echo
