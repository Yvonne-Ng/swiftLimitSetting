...
// ---------------------------------------------------------
MjjBATComparisonTool::MjjBATComparisonTool(const char * name)
{
   fName = name;
}

// ---------------------------------------------------------
MjjBATComparisonTool::~MjjBATComparisonTool()
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::AddContribution(const char * name, TH1D hist)
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::AddContribution(const char * name, double centralvalue, double uncertainty)
{
   // add name to container
   fNameContainer.push_back(name);
...
// ---------------------------------------------------------
void MjjBATComparisonTool::PrintHistograms(const char * filename)
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::DrawOverview()
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::PrintOverview(const char * filename)
{
   // create canvas
   TCanvas * c1 = new TCanvas();
   c1->cd();
