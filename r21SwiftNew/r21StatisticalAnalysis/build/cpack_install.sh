...
# Install the project:
DESTDIR=${DESTDIR}/usr/WorkDir/21.2.3 \
    make -k install/fast

# Remove the .dbg files from being packaged, in case we are in RelWithDebInfo
# build mode:
rm -f ${DESTDIR}/usr/WorkDir/21.2.3/InstallArea/x86_64-slc6-gcc62-opt/bin/*.dbg
rm -f ${DESTDIR}/usr/WorkDir/21.2.3/InstallArea/x86_64-slc6-gcc62-opt/lib/*.dbg
