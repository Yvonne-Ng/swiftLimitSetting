...
// ---------------------------------------------------------
int MjjBATAnalysisFacility::PerformSingleSystematicAnalyses(const char * dirname, const char * options)
{
   BCLog::OutSummary(Form("Running systematic analysis in directory \'%s\'.",dirname));
...
// ---------------------------------------------------------
int MjjBATAnalysisFacility::PerformCalibrationAnalysis(const char * dirname, const std::vector<double> & default_parameters, int index, const std::vector<double> & parametervalues, int nensembles)
{
