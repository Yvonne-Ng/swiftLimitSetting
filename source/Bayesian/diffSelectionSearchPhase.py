...
UserfileHistDict[inputFileDir+"MC_g150_2j25.root"] = ["Zprime_mjj_var"] # Dictionary given as example, key is inputFileDir+ file name 
...
config = "./configurations/Step1_SearchPhaseNoSyst_4ParUA2.config" # Path and name of config file
...
pos=len(HistDir)-HistDir[::-1].find('_')
print(pos)
folderextension = "MC_"+uS_string+"_"+HistDir+config[-pos:-7]
