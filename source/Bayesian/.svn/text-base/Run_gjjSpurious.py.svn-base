...
folderextension = "Spurious_dijetgamma_mc_hist_20160714_9p50fb_4Par"

inputFileDir = "./inputs/hist_20160714/OUT_dijetgamma_mc/datalike-noNeff/"

UserfileHistDict[inputFileDir+"hist.root"] = ["Zprime_mjj_var_Scaled_9p50fb"]  
...
##---------------------------
# Run controls  
config = "./configurations/Step1_Spurious_gjj_4Par.config" # Path and name of config file
