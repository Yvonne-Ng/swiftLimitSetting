...
Lumis = ["35p09"] # Luminosities to scale limits to in fb e.g. "10" or 0p1, should have corresponding search phase ran for this lumi 
...
Coupling="gSp3"
Signals["mR"]=["1p5", "p55", "p5", "p75", "p25", "p95", "p35", "p3", "p45", "p4"]
outName = ["Zprime0p10"]
