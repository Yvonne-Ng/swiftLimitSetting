...
// ---------------------------------------------------------
MjjBATComparisonTool::MjjBATComparisonTool(std::string name)
{
   fName = name;
}
...
// ---------------------------------------------------------
void MjjBATComparisonTool::AddContribution(std::string name, TH1D hist)
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::AddContribution(std::string name, double centralvalue, double uncertainty)
{
   // add name to container
   fNameContainer.push_back(name);
...
// ---------------------------------------------------------
void MjjBATComparisonTool::PrintHistograms(std::string filename)
{
...
// ---------------------------------------------------------
void MjjBATComparisonTool::PrintOverview(std::string filename)
{
   // create canvas
   TCanvas * c1 = new TCanvas();
   c1->cd();
