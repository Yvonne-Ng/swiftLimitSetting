...
void myText(Double_t x,Double_t y, Double_t textsize, Color_t color, const char *text) {

  //Double_t tsize=0.05;
  TLatex l; l.SetTextAlign(32); //l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextColor(color);
...
void myText(Double_t x,Double_t y, Double_t textsize, Int_t textalign, Color_t color, const char *text) {

  //Double_t tsize=0.05;
  TLatex l; l.SetTextAlign(textalign); //l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextColor(color);
  l.SetTextSize(textsize);
  l.DrawLatex(x,y,text);
...
void myTextLeft(Double_t x,Double_t y, Double_t textsize, Color_t color, const char *text) {
