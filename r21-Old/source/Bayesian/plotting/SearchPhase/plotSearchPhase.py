...
searchInputFile = ROOT.TFile('/lustre/SCRATCH/atlas/ywng/WorkSpace/r21/r21-Old/source/Bayesian/results/Step1_SearchPhase/test/Step1_SearchPhase_Zprime_mjj_var.root')
...
if searchInputFile.GetListOfKeys().Contains("basicData"):
    print("basic Data exist!")
    #basicData.Print()
    #print(basicData)
else:
    print("basic Data does not exist!")
print("Search inputFile Name:",searchInputFile)
...
print("fitRange0: ", fitRange[0])
print("fitRange1: ", fitRange[1])
...
myPainter.drawDataAndFitOverSignificanceHist(newbasicdata,newbasicBkgFrom4ParamFit,newresidualHist,\
        ...
        luminosity,13,fitRange[0],fitRange[1],firstBin,lastBin-1,True,bumpLowEdge/1000.0,bumpHighEdge/1000.0,[],True,False,[],True,bumpHunterPVal,1,2E12)
myPainter.drawDataAndFitOverSignificanceHist(newbasicdata,newbasicBkgFrom4ParamFit,newresidualHist,\
        'm_{jj} [TeV]','Prescale-weighted events','Significance','{0}/figure1_nobump'.format(folderextension),\
        luminosity,13,fitRange[0],fitRange[1],firstBin,lastBin-1,False,bumpLowEdge,bumpHighEdge,[],True,False,[],True,bumpHunterPVal,5E3,5E6)
...
myPainter.drawBumpHunterTomographyPlot(bumpHunterTomographyPlot,"{0}/bumpHunterTomographyPlot".format(folderextension),luminosity,13,303,611)
