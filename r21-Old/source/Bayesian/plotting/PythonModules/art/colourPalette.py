...
class ColourPalette(object) :
  ...
  def setTealColours(self) :
    ...
    # Lydia use these for spurious signal
    ##self.blue1 = ROOT.TColor(2010,0.833,1.00,0.967)
    #self.darkred = ROOT.TColor(2010,0.808,0.063,0.175)
    ...
    #self.green = ROOT.TColor(2013,124.0/255.0,194.0/255.0,66.0/255.0)
    ##self.mauve = ROOT.TColor(2014,0.817,0.792,0.783)
    #self.mango = ROOT.TColor(2014,238.0/255.0, 206.0/255.0, 0.0/255.0)
