...
#-> throw this into a function if possible
    ...
    #----drawing on pad 2 (the difference )
            ...
            print ("gh 7")
            c1.SaveAs("/lustre/SCRATCH/atlas/ywng/WorkSpace/r21/r21SwiftNew/SensitivityStudies/source/scripts/testLine_GaussianWidth3_"+"windowWidth"+str(windowWidth)+".pdf")
