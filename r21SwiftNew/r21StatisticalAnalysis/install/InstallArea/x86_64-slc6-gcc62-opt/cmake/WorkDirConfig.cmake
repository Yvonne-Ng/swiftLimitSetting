...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.3)" )
endif()
...
set( WorkDir_BASE_PROJECTS AnalysisBase;21.2.3 )
...
set( WorkDir_PACKAGE_NAMES Bayesian )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES BayesianPkg;BayesianPkgPrivate;BayesianLib;SearchPhase;SearchPhase_JESSysts;LimitSettingPhase;drawLimitBands;doGaussianLimits;setLimitsOneMassPoint;detailedGaussianOnePoint;testStartParams.cxx;doSystOnSearchOutput;simpleBumpHunter_example )
